#!/usr/bin/env python3
"""
Gesture Workspace v4  (MediaPipe Tasks API)
============================================
...
DZ_HDR = 32
SLOT_PAD_DEFAULT = 10
SLOT_W_MAX, SLOT_H_MAX = 95, 75   # caps so bricks stay reasonable across tasks
...
TASK_DEFS = [
    ...
    # pillars 5 cells tall, green 3-wide bases at the foot of each pillar.
    {
        "name": "Gate",
        "file": "task1.png",
        "cols": 9, "rows": 7,
        "layout": [
            # row 0 — yellow lintel (9)
            (0,0,"yellow"),(1,0,"yellow"),(2,0,"yellow"),(3,0,"yellow"),(4,0,"yellow"),
            (5,0,"yellow"),(6,0,"yellow"),(7,0,"yellow"),(8,0,"yellow"),
            # rows 1-5 — grey pillars at the outer columns (10)
            (0,1,"grey"),                                                              (8,1,"grey"),
            (0,2,"grey"),                                                              (8,2,"grey"),
            (0,3,"grey"),                                                              (8,3,"grey"),
            (0,4,"grey"),                                                              (8,4,"grey"),
            (0,5,"grey"),                                                              (8,5,"grey"),
            # row 6 — green 3-wide bases on each side (6)
            (0,6,"green"),(1,6,"green"),(2,6,"green"),
            (6,6,"green"),(7,6,"green"),(8,6,"green"),
        ],
    },
    # Task 2 — Goalpost. Red caps top & bottom of each pillar, grey shaft
    # between, a 7-wide blue crossbar at row 1, green base across the
    # full 11-cell width.
    {
        "name": "Goalpost",
        "file": "task2.png",
        "cols": 11, "rows": 7,
        "layout": [
            # row 0 — red caps poking above the crossbar
            (1,0,"red"),                                                                       (9,0,"red"),
            # row 1 — crossbar: red at the pillars, 7 blues between
            (1,1,"red"),(2,1,"blue"),(3,1,"blue"),(4,1,"blue"),(5,1,"blue"),
            (6,1,"blue"),(7,1,"blue"),(8,1,"blue"),(9,1,"red"),
            # rows 2-4 — grey pillar shafts
            (1,2,"grey"),                                                                      (9,2,"grey"),
            (1,3,"grey"),                                                                      (9,3,"grey"),
            (1,4,"grey"),                                                                      (9,4,"grey"),
            # row 5 — red feet at the bottom of each pillar
            (1,5,"red"),                                                                       (9,5,"red"),
            # row 6 — green base, full width (11)
            (0,6,"green"),(1,6,"green"),(2,6,"green"),(3,6,"green"),(4,6,"green"),
            (5,6,"green"),(6,6,"green"),(7,6,"green"),(8,6,"green"),(9,6,"green"),(10,6,"green"),
        ],
    },
    # Task 3 — Cross / figure. Blue head & feet caps, blue arms with a red
    # heart at row 2, green "body" filling the corners on rows 3-4 around
    # the empty spine (col 3).
    {
        "name": "Cross",
        "file": "task3.png",
        "cols": 7, "rows": 6,
        "layout": [
            # row 0 — blue cap (head)
                                                            (3,0,"blue"),
            # row 2 — blue arms + red center
            (0,2,"blue"),                                  (3,2,"red"),                                    (6,2,"blue"),
            # rows 3 & 4 — green body in two 3-wide blocks (col 3 stays empty)
            (0,3,"green"),(1,3,"green"),(2,3,"green"),                  (4,3,"green"),(5,3,"green"),(6,3,"green"),
            (0,4,"green"),(1,4,"green"),(2,4,"green"),                  (4,4,"green"),(5,4,"green"),(6,4,"green"),
            # row 5 — blue cap (feet)
                                                            (3,5,"blue"),
        ],
    },
    # Task 4 — Pyramid. Classic stepped pyramid: 1 green peak, 3 red, 5
    # yellow, 7 blue, 9 green base. Each layer two cells wider than the one
    # above it, centered over col 4.
    {
        "name": "Pyramid",
        "file": "task4.png",
        "cols": 9, "rows": 5,
        "layout": [
            # row 0 — peak (1 green)
                                                                          (4,0,"green"),
            # row 1 — red (3)
                                                            (3,1,"red"),  (4,1,"red"),  (5,1,"red"),
            # row 2 — yellow (5)
                                          (2,2,"yellow"),(3,2,"yellow"),(4,2,"yellow"),(5,2,"yellow"),(6,2,"yellow"),
            # row 3 — blue (7)
                            (1,3,"blue"),(2,3,"blue"),(3,3,"blue"),(4,3,"blue"),(5,3,"blue"),(6,3,"blue"),(7,3,"blue"),
            # row 4 — green base (9)
            (0,4,"green"),(1,4,"green"),(2,4,"green"),(3,4,"green"),(4,4,"green"),
            (5,4,"green"),(6,4,"green"),(7,4,"green"),(8,4,"green"),
        ],
    },
...
class App:
    ...
    PINCH_ON  = 0.050
    PINCH_OFF = 0.085
    HIT_PAD   = 10        # extra px around a brick for forgiving targeting
    ...
    def _configure_slots(self):
        ...
        slot_w = max(20, (avail_w - (cols + 1) * slot_pad) // cols)
        slot_h = max(20, (avail_h - DZ_HDR - (rows + 1) * slot_pad) // rows)
        ...
        # Brick fits inside slot with a small inset
        self.brick_w = max(20, int(slot_w * 0.85))
        self.brick_h = max(16, int(slot_h * 0.82))
    ...
    def _draw_action_workspace(self, frame):
        ...
        if self.dragging is not None and self.r_pinch:
            drag_preview = self._nearest_slot(
              ...
              and self.r_ptr is not None and self.hovered is None):
            # Only preview a paste target when the cursor is NOT over an
            # existing brick — if a brick is hovered, the next pinch will
            # copy it, not paste, so showing a yellow slot here would lie.
            cx, cy = self.r_ptr
...
def main():
    ...
    print("Gesture Workspace v4  |  'q' quit  |  'f' fullscreen toggle  |  '1'-'9' jump to task")
